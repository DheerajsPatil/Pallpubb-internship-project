from tkinter import *
from myscribblestudent import studentClass
from myscribbleschool import SchoolClass
class scribble:
    def __init__(self,root):
        ...
        lbl_my_scribble =Label(pall_magzine_rectangle, text="My First Scribble", fg="#FFFFFF", bg="#2F4D99", font=("Helvetica", 35, "bold"))
