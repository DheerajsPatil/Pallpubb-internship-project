    ...
    def add(self):
        ...
        try:
            if self.var_student.get()=="":
                ...
                cur.execute("Select * from student where stuname=?",(self.var_student.get(),))
                row=cur.fetchone()
                cur.execute("Insert into student (stuname,schname,contact,address) values(?,?,?,?)",(
         ...
         try:
             if self.var_student.get()=="":
                 ...
                 if row==None:
                     ...
                     cur.execute("Update student set schname=?,contact=?,address=? where stuname=?",(
                                        self.var_school.get(),
                                        self.var_contact.get(),
                                        self.txt_address.get('1.0',END),
                                        self.var_student.get(),   
          ...
          try:
               if self.var_student.get()=="":
                 ...
                 if row==None:
                     ...
                     if op==True:
                         cur.execute("delete from student where stuname=?",(self.var_student.get(),))
                         con.commit()
