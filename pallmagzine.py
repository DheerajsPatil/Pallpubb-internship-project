from tkinter import *
from magzineissue import IssueClass
from magzineclients import ClientsClass
class Pallmagzine:
    def __init__(self,root):
        ...
        lbl_pall_magzine =Label(pall_magzine_rectangle, text="PALL  MAGZINE", fg="#FFFFFF", bg="#2F4D99", font=("Helvetica", 35, "bold"))
        lbl_pall_magzine.pack(pady=20)
        ...
        btn_clients =Button(btn_frame, text="CLIENTS",font=("",16,"bold"),bg="#769ADD",fg="#FFFFFF",width=10,command=self.Clients,activebackground="#769ADD",activeforeground="White")
        btn_clients.pack(side=LEFT, padx=50)
        # Create the Issue button
        btn_issue =Button(btn_frame, text="ISSUE",font=("",16,"bold"),bg="#769ADD",fg="#FFFFFF",width=10,command=self.Issue,activebackground="#769ADD",activeforeground="White")
        btn_issue.pack(side=RIGHT, padx=50)

    

    def Issue(self):
        self.new_win=Toplevel(self.root)
        self.new_obj=IssueClass(self.new_win)
